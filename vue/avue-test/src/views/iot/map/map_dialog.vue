<template>
  <div class="map-dialog">
    <h1 class="map-tooltip-loading" v-show="dialogData.loadShow">
      <i class="el-icon-loading"></i>
    </h1>
    <div class="map-tooltip-header" v-show="!dialogData.loadShow">
    ...
    <div class="map-tooltip-main" v-show="!dialogData.loadShow">
    ...
    <div class="map-tooltip-footer" @click="showInfo" v-show="!dialogData.loadShow">
